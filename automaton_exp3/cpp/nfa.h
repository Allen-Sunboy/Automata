...
struct Rule {
    ...
    bool match(char a, bool flag_s);

    bool in[129]; // 对于中括号字符组[]，记录能匹配的字符
...
public:
    ...
    std::vector<std::pair<int, int> > group[20001];
    ...
    Path backtrace(path_element path[], int step);
